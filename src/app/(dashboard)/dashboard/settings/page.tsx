    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue={defaultTab} onValueChange={handleTabChange} className="space-y-6">
        <TabsList className="bg-slate-800/50 border border-slate-700 p-1.5 h-auto flex-wrap">
          <TabsTrigger value="account" className="px-4 py-2.5 text-sm font-medium gap-2 data-[state=active]:bg-emerald-500/30 data-[state=active]:text-emerald-300">
            <User className="h-4 w-4" />
            <span className="hidden sm:inline">Account</span>
          </TabsTrigger>
          <TabsTrigger value="notifications" className="px-4 py-2.5 text-sm font-medium gap-2 data-[state=active]:bg-blue-500/30 data-[state=active]:text-blue-300">
            <Bell className="h-4 w-4" />
            <span className="hidden sm:inline">Notifications</span>
          </TabsTrigger>
          <TabsTrigger value="subscription" className="px-4 py-2.5 text-sm font-medium gap-2 data-[state=active]:bg-amber-500/30 data-[state=active]:text-amber-300">
            <CreditCard className="h-4 w-4" />
            <span className="hidden sm:inline">Subscription</span>
          </TabsTrigger>
          <TabsTrigger value="family" className="px-4 py-2.5 text-sm font-medium gap-2 data-[state=active]:bg-purple-500/30 data-[state=active]:text-purple-300">
            <Users className="h-4 w-4" />
            <span className="hidden sm:inline">Family</span>
          </TabsTrigger>
          <TabsTrigger value="security" className="px-4 py-2.5 text-sm font-medium gap-2 data-[state=active]:bg-red-500/30 data-[state=active]:text-red-300">
