...
const plans = [
  {
    ...
    features: [
      ...
      { text: "Full exposure report", included: true },
...
const faqs = [
  {
    ...
    answer:
      "Sign up and run a free scan to see where your data is exposed. You get 2 scans per month and a full exposure report. Upgrade to Pro or Enterprise to start automated removals.",
  },
  {
