  ...
  const schema = {
    ...
    offers: [
      ...
      },
      {
        "@type": "Offer",
        name: "Pro Plan",
        description: "Full protection with unlimited scans, automated removal requests, and weekly monitoring. 40% OFF sale.",
        price: "19.99",
        priceCurrency: "USD",
        availability: "https://schema.org/InStock",
        url: "https://ghostmydata.com/register",
      ...
      },
      {
        "@type": "Offer",
        name: "Enterprise Plan",
        description: "Complete protection with dark web monitoring, family plan for 5 profiles, and daily monitoring. 40% OFF sale.",
        price: "49.99",
        priceCurrency: "USD",
        availability: "https://schema.org/InStock",
        url: "https://ghostmydata.com/register",
