...
export const AUTHORS: Record<string, Author> = {
  "rocky-kathuria": {
    ...
    slug: "rocky-kathuria",
    role: "Founder & CEO",
    bio: "Rocky Kathuria is the founder and CEO of GhostMyData, a data privacy platform that helps individuals remove their personal information from data brokers and the internet. With deep expertise in CCPA, GDPR, and state privacy laws, Rocky built GhostMyData to automate what was previously a tedious, manual process — submitting opt-out requests to hundreds of data brokers one by one. Under his leadership, GhostMyData has grown to scan 2,100+ data brokers using advanced automation, making it one of the most comprehensive data removal services available.",
    expertise: [
      "Data Privacy & CCPA/GDPR Compliance",
      "Data Broker Removal Processes",
      "Privacy Automation Technology",
