...
export const DATA_BROKER_DIRECTORY: Record<string, DataBrokerInfo> = {
  ...
  RADARIS: {
    ...
    subsidiaries: [
      "CENTEDA", "VIRTORY", "CLUBSET", "PERSONTRUST",
      // PUBLICREPORTS removed — redirects to centeda.com
  ...
  INFOTRACER: {
    ...
    subsidiaries: [
      ...
      "USRECORDS",
      "SEARCHUSAPEOPLE", "FREEBACKGROUNDCHECK_IP", "BIRTHRECORDS",
      // DEATHRECORDS, CRIMINALRECORDS — dead sites
      // REVERSERECORDS, INFOPAGES — redirect to infotracer.com
    ],
  },
...
export const BROKER_CATEGORIES = {
  PEOPLE_SEARCH: [
    ...
    "FAMILYTREENOW", "MYLIFE", "CLUSTRMAPS", "ADDRESSES",
    "ADVANCED_PEOPLE_SEARCH", "ZABASEARCH", "PEEKYOU",
    "PERSOPO", "SMARTBACKGROUNDCHECKS", "LOCATEFAMILY",
    "VIRTORY", "VERICORA",
    "GLADIKNOW", "QUICKPEOPLETRACE", "OURSTATES", "IDCRAWL",
    "INFOFREE", "CENTEDA", "KWOLD", "NEWENGLANDFACTS", "OFFICIALUSA",
    "PUB360", "PROFILEENGINE", "PUBLICINFOSERVICES", "PEOPLEBACKGROUNDCHECK",
    "PRIVATERECORDS", "PEOPLEWHIZ", "SEARCHBUG", "STATERECORDS",
    "UNITEDSTATESPHONEBOOK", "USA_PEOPLE_SEARCH", "USATRACE", "VERIPAGES", "WELLNUT",
    "FREEPHONETRACER", "FINDPEOPLESEARCH", "PEOPLESMART", "PEOPLEFINDERPRO_V2",
    "DATAVERIA", "CYBERCHECK", "INFOTRACER", "COCOFINDER", "USPHONELOOKUP",
    "EASYBACKGROUNDCHECKS", "UNMASK", "INFORMATION_COM",
    "DOBSEARCH", "NEIGHBOR_REPORT", "VALIDNUMBER", "SEARCHPUBLICRECORDS",
    "PUBLICRECORDCENTER",
    "PERSONSEARCHERS",
    "PUBLICSEARCHER",
    ...
    "VERIFYRECORDS", "BIRTHRECORDS", "GOVERNMENTREGISTRY",
    "VERIFYPUBLICRECORDS", "GOVWARRANTSEARCH"
    // Removed dead/redirect sites: PUBLICRECORDSNOW, BEEN_VERIFIED_PEOPLE, PUBLICRECORDS360,
    // PEOPLEWISE, PEOPLESEARCHNOW, PEOPLEBYNAME, IDENTITYPI, CUBIB, SPYTOX, USSEARCHINFO,
    // REVEALNAME, BACKGROUNDALERT, NUMERLOOKUP, IDTRUE, LOOKUPUK, PEEPSEARCH, RECORDSFINDER,
    // SEARCHSYSTEMS, PERSONSEARCH, ARKANSASVOTERS, FLORIDAVOTERS, OHIOVOTERS, GOLOOKUP,
    // PUBLICDATAUSA, FOUR11_INFO, CITY_DATA, LOCATEPEOPLE, PEEPLOOKUP, NUMLOOKER,
    // FOUR11_LOCATE, ZOSEARCH, FINDPEOPLEFAST, REVERSERECORDS, INFOPAGES,
  ...
  BACKGROUND_CHECK: [
    ...
    "FIRST_ADVANTAGE", "INTELLICORP", "TALENTWISE", "INFOMART",
    "BACKGROUNDCHECKERS", "FREEBACKGROUNDCHECK",
    // SJV_ASSOCIATES removed — site dead
  ...
  COURT_RECORDS: [
    "JUDYRECORDS", "UNICOURT", "ARRESTFACTS",
    "CRIMINALSEARCHES", "MUGSHOTS_COM",
    "CRIMINALWATCHDOG", "DOCKETBIRD", "PACERMONITOR", "TRELLIS_LAW",
    "COURTLISTENER", "DOCKETALARM"
    // Removed dead: COURTRECORDS_ORG, INSTANTARREST, PUBLICPOLICERECORD
  ],
  PHONE_LOOKUP: [
  ...
  PROPERTY_RECORDS: [
    ...
    "HOUSEVALUES", "LANDWATCH", "REALTYHOP", "SHOWCASE",
    // ADDRESSREPORT removed — site dead (404)
